...
const NumberBetting = (id, gameName) => {
  ...
  //   const urlencoded = new URLSearchParams();
  //   // urlencoded.append("gameName","Number Betting")
  //   // urlencoded.append("gameRules", values.description);
  //   //  urlencoded.append("gameId", gameId);
  //   urlencoded.append("gameRules", values.description);
  //   DataService.post(Api.ADMIN_GAME_RULES_ADD, urlencoded)
  ...
  await  DataService.get(Api.ADMIN_GAME_RULES)
      .then((res) => {
  ...
  //     // const game = data?.find((row)=>row?.gameName == "Number Betting")
  //     // const game = data?.find((row)=>row?._id == "Number Betting")
  //     // const game = data?.find((row)=>row?._id == gameId)
  //     setInitialGameRule({
