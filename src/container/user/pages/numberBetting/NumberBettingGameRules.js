...
export default function NumberBettingGameRules() {
                ...
                <Index.Box className="seconds-select-details-modal">
                  <Index.Box className="bet-details-img">
                    <img
                      ...
                      alt="Number-Betting"
                      className="center-bet-img center-number-bet-img contain-img"
                    ></img>
                  </Index.Box>
                  <Index.Box className="seconds-select-content">
                    <Index.Box className="seconds-three-flex">
                      ...
                      >
                        {/* {hours ? "second-divide-content second-onclick-active" : "second-divide-content"} onClick={() => setHours(+data?.ele?.gameHours)}> */}
